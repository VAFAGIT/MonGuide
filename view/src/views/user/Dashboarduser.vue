  ...
  <div>
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
      ...
      <div
        ...
        "
        class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-purple-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0"
      >
        <div class="flex items-center justify-center mt-8">
          <div class="flex items-center">
            <a href="/" class="h-20 w-60">
              <img src="/logo.png" />
            </a>
          </div>
        </div>
      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        <header
          class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-amber-500"
        >
          <div class="flex items-center">
            <button
            ...
            <div x-data="{ dropdownOpen: false }" class="relative">
              ...
              >
               ...
               <button
                ...
                class="relative block p-1 rounded-full overflow-hidden shadow focus:outline-none"
              >
                LogOut
              </button>
              </div>
                ...
                >
                  <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                      <tr v-for="trav in travel" :key="trav.id">
                        <td
...
export default {
  ...
  methods: {
    gettravel() {
      fetch("http://localhost/api/Voyages/getall", {
        method: "GET",
      })
    ...
    BookOn(id) {
      ...
      const newLocl = "http://localhost/api/Reservations/addReservation";
